  ...
  <div class="execution-view">
    ...
    <section class="cockpit">
      ...
      <main v-if="selected">
        ...
        <div class="real-progress"><div><span>处理步骤进度</span><b>{{ selected.completed_steps || 0 }} / {{ selected.total_steps || 1 }}</b></div><i><em :style="{width:`${selected.progress}%`}"></em></i><small>仅在处理步骤实际完成后推进，不按等待时间模拟。</small></div>

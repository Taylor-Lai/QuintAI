...
Documentation is organized by audience: architecture explains boundaries,
development covers contributor workflows, operations covers deployment, and
ADRs record decisions that should not be silently reversed.

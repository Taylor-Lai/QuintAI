...
public class HuiwenRongtongApiContractTest {
    ...
    public void androidClientExposesEveryWebApiRoute() {
        ...
        Set<String> expected = new HashSet<>(Arrays.asList(
            ...
            "GET enterprise/templates", "POST enterprise/templates", "PUT enterprise/templates/{id}", "DELETE enterprise/templates/{id}",
            ...
            "GET enterprise/knowledge/{id}/graph", "POST enterprise/knowledge/{id}/graph/rebuild",
            "PATCH enterprise/knowledge/{id}/graph/entities/{entityId}", "GET enterprise/schedules", "POST enterprise/schedules",
            "DELETE enterprise/schedules/{id}", "PUT enterprise/subscription", "GET enterprise/operations",
            "GET enterprise/backups", "POST enterprise/backups", "GET enterprise/backups/{id}/download", "GET enterprise/comments", "POST enterprise/comments",
